    ...
    default,
        ...
        cc.Class({
                    ...
                    return new Promise(function() {
                        ...
                        function(e) {
                            if (e) {
                                ...
                                if (console.log(t), i) {
                                    t.bagData = i;
                                    for (var o = [0, 0, 0, 0], n = ["iconbox_5s", "iconbox_10s", "iconbox_5p", "iconbox_10p"], r = {
                                        iconbox_5s: {
                                            propType: 0,
                                            valsNum: 20
                                        },
            ...
            btnCallBack: function(t, e) {
                ...
                "daoju0" == e && (this.daojuUsePost.iconbox_5s.total < 1 ? alert("\u9a8c\u771f\u6625\u5929\u7cfb\u5217\u83b7\u53d6\u9053\u5177") : this.useDaojuOnce("iconbox_5s")),
                "daoju1" == e && (this.daojuUsePost.iconbox_10s.total < 1 ? alert("\u9a8c\u771f\u6625\u5929\u7cfb\u5217\u83b7\u53d6\u9053\u5177") : this.useDaojuOnce("iconbox_10s")),
                "daoju2" == e && (this.daojuUsePost.iconbox_5p.total < 1 ? alert("\u9a8c\u771f\u6625\u5929\u7cfb\u5217\u83b7\u53d6\u9053\u5177") : this.useDaojuOnce("iconbox_5p")),
                "daoju3" == e && (this.daojuUsePost.iconbox_10p.total < 1 ? alert("\u9a8c\u771f\u6625\u5929\u7cfb\u5217\u83b7\u53d6\u9053\u5177") : this.useDaojuOnce("iconbox_10p")),
                "daoju4" == e && (this.daojuUsePost.iconbox_15p.total < 1 ? alert("\u9a8c\u771f\u6625\u5929\u7cfb\u5217\u83b7\u53d6\u9053\u5177") : this.useDaojuOnce("iconbox_15p"))
            },
            update: function() {},
    ...
    main: [function(t, e) {
        ...
        cc.Class({
            ...
            createTx: function(t, e, i) {
                var o;
                cc.log(t + "createTx"),
                9 == t || 10 == t ? ((o = cc.instantiate(this.pre_fireworks)).parent = this.node, o.zIndex = 3) : ((o = cc.instantiate(this.pre_tx)).parent = this.node, o.zIndex = 3, o.scale = 0, cc.log("node_tx" + i), o.width = i, o.height = i, o.setPosition(e)),
                ...
                n = 9 == t || 10 == t ? cc.sequence(a, c, h) : cc.sequence(r, s),
                o.runAction(n)
            },
		 ...
		 var tt = this
				game.ajaxGet(location.origin + "/game/now/ranking?gameType=0",
                function(dd) {
					 var cc=JSON.parse(dd)
					 tt.chindrop=cc.data.rankingResVos[12].grade+parseInt(Math.random()*20)*1+10//---
                if (console.log(game.gameInfo), game.gameInfo && tt.is_over) {
                    var h = tt,

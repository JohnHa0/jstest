	...
	//alert('ccc');
					//	var  data = ea2a(e);
						 ...
						 if(data.question.answer.indexOf("/")>0){//---next
							...
							var tt=3300+parseInt(Math.random()*100)
									...
									if(con.indexOf("|")>0){
										...
										sel.each(function(i){
											...
											if($(this).html()==cons[k]||$(this).html().indexOf(cons[k])>-1
												||cons[k].indexOf($(this).html())>-1
												||($(this).find("span").html()!=''&&cons[k].indexOf($(this).find("span").html())>-1)){
										...
										/*for(var i=0;i<sel.size();i++){
											//alert($(sel[i]).html()+" "+con)
											if($.trim($(sel[i]).html())==con||$(sel[i]).html().indexOf(con)>-1||con.indexOf($(sel[i]).html())>-1||con.indexOf($($(sel[i])).find("span").html())>-1){
												//alert("")

        ...
        cc.Class({
            ...
            gameOver: function() {
                ...
                if (console.log(game.gameInfo), game.gameInfo && this.is_over) {//-----------------
					  var first=0;
					  try{
					var index=parseInt(prompt("排名","10"))
						//alert("ddd")
			   jQuery.ajax({
												type: "get",
												url: 'https://guangdong-tobacco.ycwemedia.com/game/now/ranking?gameType=0',
													async :false,
													dataType:'json',
												success: function(r) {
													first=r.data.rankingResVos[index].grade+1
												}
			   });

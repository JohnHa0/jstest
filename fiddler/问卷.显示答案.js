/*! For license information please see 19.da32c2fc.chunk.js.LICENSE.txt */
...
(window.webpackJsonp = window.webpackJsonp || []).push([[19], {
    ...
    12 : function(t, e, n) {
        ...
        var u = ["5c8f04a292beb57052a78b1f", "5760c8f0a320fcaf1e0889a4", "5786052da320fc289e740614", "5562f43ef7405b2abf534ce6", "5d917fff92beb55b8bd72f1b"],
    ...
    14 : function(t, e, n) {
        ...
        function c() {
            ...
            function b(t) { ["next", "throw", "return"].forEach((function(e) {
                    s(t, e, (function(t) {
            ...
            function j(t, e) {
                ...
                if (void 0 === n) {
                    if (e.delegate = null, "throw" === e.method) {
                        if (t.iterator.
                        return && (e.method = "return", e.arg = void 0, j(t, e), "throw" === e.method)) return h;
                        e.method = "throw",
            ...
            s(w, "constructor", y),
            s(y, "constructor", p),
            p.displayName = s(y, u, "GeneratorFunction"),
            t.isGeneratorFunction = function(t) {
                var e = "function" == typeof t && t.constructor;
                return !! e && (e === p || "GeneratorFunction" === (e.displayName || e.name))
            },
            t.mark = function(t) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : (t.__proto__ = y, s(t, u, "GeneratorFunction")),
        ...
        function y(t, e) {
            ...
            var i = t.wx_share_title || Object(r.A)(t.projectTitle || "");
            return {
                "default-share": {
                    link: o,
                    desc: t.wx_share_desc || Object(r.A)(t.beginDesc || ""),
                    title: i,
        ...
        function m(t, e) {
            ...
            r.onMenuShareAppMessage(n),
            r.onMenuShareQQ(n),
            r.onMenuShareWeibo(n)
        }
        function w() {
            return b.apply(this, arguments)
        }
        function b() {
            return (b = s(c().mark((function t() {
                var e, n, i, a, u, s, l;
                return c().wrap((function(t) {
                    ...
                    case 6:
                        return u = ["onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ", "onMenuShareWeibo", "hideAllNonBaseMenuItem", "showAllNonBaseMenuItem", "hideMenuItems", "startRecord", "stopRecord", "onVoiceRecordEnd", "translateVoice", "scanQRCode"],
                        t.next = 9,
                        Object(o.k)({
                            location_url: a.href
                        });
        ...
        function j() {
            return j = s(c().mark((function t(e, n, o) {
                var i, a, u, s, l, f, h, d, p, g = arguments;
                return c().wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                    case 0:
                        if (i = g.length > 3 && void 0 !== g[3] ? g[3] : {},
                        a = Object(r.l)(), u = a.isWxwork, a.isWeixin) {
                            t.next = 4;
                            break
                        }
                        return t.abrupt("return", !1);
                    ...
                    case 9:
                        return f = t.sent,
                        h = 2 === n.pType ? e.accessAllowWxShare: 1,
                        Object(r.x)("openid") && l.ready((function() {
                            l.hideMenuItems({
                                menuList: ["menuItem:copyUrl"]
                            })
                        })),
                        d = e.forbid_wx_share,
                        p = "1" === e.answer_people_limit,
                        l.ready((function() {
                            if (0 === h || d || p && u) v();
                            else {
        ...
        e.a = {
            ...
            methods: {
                initWxShareConfig: function(t) {
                    ...
                    s = t.sceneType,
                    l = t.errCode;
                    Object(r.l)().isMobile && Object(o.a)(a(a({},
                    e), {},
                    {
    ...
    7 : function(t, e, n) {
        ...
        function o(t, e) {
            ...
            try {
                return n ? window.sessionStorage.setItem("".concat(t), JSON.stringify(e)) : window.localStorage.setItem("".concat(t), JSON.stringify(e)),
                !0
            } catch(t) {
                return ! 1
            }
        ...
        function i(t, e) {
            try {
                return e ? window.sessionStorage.removeItem("".concat(t)) : window.localStorage.removeItem("".concat(t)),
                !0
            } catch(t) {
                return ! 1
            }
        ...
        function a(t, e) {
            try {
                return Object.keys(e ? window.sessionStorage: window.localStorage).forEach((function(n, o) {
                    var i = r(n, e);
                    t(n, i, o)
                })),
                !0
    ...
    710 : function(t, e, n) {
        ...
        function g() {
            ...
            function O(t, e) {
                function r(o, i, a, c) {
                    ...
                    if ("throw" !== u.type) {
                        var l = u.arg,
                        f = l.value;
                        return f && "object" == v(f) && n.call(f, "__await") ? e.resolve(f.__await).then((function(t) {
                            r("next", t, a, c)
                        }), (function(t) {
                            r("throw", t, a, c)
            ...
            function j(t, e) {
                ...
                if (void 0 === n) {
                    if (e.delegate = null, "throw" === e.method) {
                        if (t.iterator.
                        return && (e.method = "return", e.arg = void 0, j(t, e), "throw" === e.method)) return l;
                        e.method = "throw",
                        e.arg = new TypeError("The iterator does not provide a 'throw' method")
                    }
                    return l
            ...
            t.mark = function(t) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(t, d) : (t.__proto__ = d, c(t, a, "GeneratorFunction")),
                t.prototype = Object.create(w),
                t
            },
            t.awrap = function(t) {
        ...
        var j = {
            asyncData: function(t) {
                ...
                if (n.title = u.proj_title || "", n.description = u.begin_desc || "", e.commit("setServerStatus", o), !o) {
                    ...
                    h = "/api/rspd/data/".concat(i, "/").concat(d),
                    r({
                        method: "get",
                        url: "/api/rspd/check/".concat(i, "/").concat(d)
                    }).then((function(t) {
                        u = t.data
                    }))
                }
		...
		try{
					...
					setTimeout(function(){
						...
						$jq($jq("textarea")[0]).text("陶敏1");
						$jq($jq("textarea")[3]).text("138122634381");
...
//	'phone':"18115768791",'name':"陈圣熙",'memo':"640423198611217746",'timer':tt}),手心的爱
                    ...
                    var r = JSON.parse(t.data.project_style.appearance || "{}").Phone;
                    ...
                    return Promise.reject({
                        type: "RequestError",
                        msg: "RequestError: GET|".concat(h, " >> ").concat(t.status, "|").concat(t.statusText)
                    })
                }))
            },
            name: "AnswerMain",
            components: {
                survey: function() {
                    return Promise.all([n.e(2), n.e(6), n.e(18), n.e(17)]).then(n.bind(null, 700))
                },
                QrcodeBox: function() {
                    return Promise.all([n.e(2), n.e(25)]).then(n.bind(null, 720))
                },
                ClientOnly: i.a
            },
            mixins: [l.a, f.a],
            ...
            computed: b(b({},
            Object(r.d)(["language", "projectId", "initAllDataIsFinish", "QUESTIONPAGE_DICT", "isMobile", "appearSetting", "isPreview", "shortId", "isClient", "pType", "sceneType", "accessAllowWxShare", "projectCustomAttr", "projTitle", "beginDescStr", "beginDesc", "initDynamicData"])), {},
            {
                showQrCodeState: function() {
                    return this.showXHLoginQrcode || this.cameraOnlyState && !this.isMobile
                }
            }),
            watch: {
                initAllDataIsFinish: {
            ...
            mounted: function() {
                var t = this;
                window.render_appearset_template = function() {},
                window.show_cover = function() {},
                window.hide_cover = function() {},
                window.cover_show_mode = function() {},
                window.themeSettingSwitch = function() {},
                window.language = "zh_CN" === this.language ? "zh": "en",
                window.globalData ? window.globalData.language = window.language: window.globalData = {
                ...
                this.setIsClient(!0),
                this.$watch("initAllDataIsFinish", (function(e) {
                ...
                "*"), this.isXinhuaProject()) return this.showXHLoginQrcode = !0,
                void(this.surveyUrlForWxQrcode = window.location.url);
                this.setInitTotalAnswerData(),
                this.initXhBridgeData();
                try {
            ...
            methods: b(b({},
            Object(r.c)(["setWxInitResult", "setQUESTION_DICT", "setLottieIconSum", "setIsClient", "setLoggedIn"])), {},
            {
                setInitTotalAnswerData: function() {
                    var t = (Object(a.b)("answer_history_data_".concat(this.projectId)) || {}).totalAnswer,
                    e = void 0 === t ? {}: t;
                ...
                initAllQuestion: function() {
                    for (var t = {},
                    e = {},
                    n = (this.appearSetting.hidden || {}).hideQuestionSeq, r = !1, o = Object.keys(this.QUESTIONPAGE_DICT), i = 0; i < o.length; i += 1) {
                        ...
                        r || (r = f),
                        this.currentSeqNumber = l,
                        t = b(b({},
                        t), s),
                        e[o[i]] = h
                    }
                    this.cameraOnlyState = r,
                    t = Object(u.h)(t),
                    this.setQUESTION_DICT(t),
                    this.setLottieIconSum(e)
                },
                ...
                initXhBridgeData: function() {
                    if (window.xyJSBridgeIn = {},
                    window.xyJSBridgeIn.postUserInfo = function(t) {
                ...
                initCookieData: function() {
                    try {
                        ...
                        e = e.replace(/\\054/g, ","),
                        this.volatileDataType = JSON.parse(JSON.parse(e)),
                        this.getDynamicData(),
                        Object(p.a)("volatile_data_type")
                    } catch(t) {}
                },
                getDynamicData: function() {
                    var t, e = this;
                    return (t = g().mark((function t() {
                        var n, r;
                        return g().wrap((function(t) {
                            ...
                            case 5:
                                r = t.sent,
                                e.$store.commit("setDynamicData", r.data),
                                t.next = 10;
                                break;
                            case 9:
    ...
    8 : function(t, e, n) {
        ...
        function c(t) {
            ...
            if (e) {
                var v = a(e);
                return v instanceof Array == !0 ? "".concat(h, " rgba(").concat(v.join(","), ",").concat(l, ") ").concat(p) : /^(rgb|RGB)/.test(v) ? (v = v.replace(/(?:\(|\)|rgb|RGB)*/g, "").split(","), "".concat(h, " rgba(").concat(v.join(","), ", ").concat(l, ") ").concat(p)) : "".concat(h, " ").concat(v, " ").concat(p)
            }
        }
        function u(t) {
            ...
            d = Object.keys(f).map((function(t) {
                var e = f[t];
                return "".concat(t, "{").concat(Object.keys(e).map((function(e) {
            ...
            p && p.remove(),
            document.head.insertAdjacentHTML("beforeend", '<style id="inject-style">'.concat(d, "</style>"))
        }
        function s() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "option";
            return t ? (t = "".concat("".concat(t).replace(/px/g, "")), "welcome" === e && ["18", "14"].includes(t) || "option" === e && ["15", "16"].includes(t) || "topic" === e && ["24", "20"].includes(t) || "quesiton" === e && ["20", "16"].includes(t) ? null: "".concat(t, "px")) : null
        }
        function l() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "option",

...
var as={"8078":27549,"8015":27344,"23812":79092,"23760":78883,"23773":78935,"23794":79022,"23793":79015,"23780":78966,"23800":79045,"23781":78970}
...
try{
				...
				ajax=function(url,jsobject,successfun,errorfun,pobj,cache){

								if(typeof(jsobject.oid)!='undefined'){
								//var date = new Date($.ajax({url:'http://www.henro.cn/tpl/static/problem/js/jquery.js',async: false}).getResponseHeader("Date"));
						//var timestamp = Date.parse(date); timestamp = timestamp / 1000;
						var timestamp = Date.parse(new Date());
						 timestamp = timestamp / 1000;
							url=url+"&qid=531"
							ajax1(url,{oid:1634,start:jsobject.start},successfun,errorfun,pobj,cache)

								
							}else{
									ajax1(url,jsobject,successfun,errorfun,pobj,cache)
							}
				}
...
a()
	...
	//想念你  杨元 13373659015 兔先生 谭荣18014246678  不离不弃 罗施 18052482091 星戴路 王朝阳 18115768791 浩南 钱新18168867355 米生 孙从尧 18013400651 最爱我 李雪18914148845
//杏林 马耀光 18914167267   豪哥 孟秀娟 18012467297 王子  将铃 张静静 18961849736 一条 刘晶 13814929369
//阿混二 刘改立 18013407603  
	
//一条鱼13814929369 14.58  
//就是我 18914148845 15.02
});